...
func (m *mcpMockStore) DeferNode(_ context.Context, _ string, _ *time.Time, _, _ string) error {
	return nil
}
func (m *mcpMockStore) WakeDeferredNode(_ context.Context, _ string, _ time.Time) (bool, error) {
	return false, nil
}
